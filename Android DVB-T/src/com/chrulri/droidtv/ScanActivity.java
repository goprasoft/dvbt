...
public class ScanActivity extends Activity implements OnClickListener,
    ...
    class AsyncScanTask extends AsyncTask<Void, CharSequence, String> {
        ...
        protected void onPreExecute() {
            ...
            _type = (String) Utils.decode(_dvbType, 
            		DvbType.ATSC, "a",
            		//   DvbType.DVBC, "c",
            		//     DvbType.DVBS, "s",
            		    DvbType.DVBT, "t");
        ...
        protected String doInBackground(Void... params) {
            try {
                ...
                if (exitCode == null) {
                    ...
                    ErrorUtils.error(ScanActivity.this, "Sorry, no device was found. Please check the connection! Have the folder dvb and adapter0 permission 777 ? If the problem persists, please contact us at the e-mail support. (" + exitCode + ")");
                }
            } catch (Throwable t) {
                Log.e(TAG, "wscan", t);
